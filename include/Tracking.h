...
public:
    ...
    bool ParseORBParamFile(cv::FileStorage &fSettings, const string &strSettingPath);
    bool ParseIMUParamFile(cv::FileStorage &fSettings);

    // Preprocess the input and call Track(). Extract features and performs stereo matching.
    Sophus::SE3f GrabImageStereo(const cv::Mat &imRectLeft,const cv::Mat &imRectRight, const double &timestamp, string filename);
    Sophus::SE3f GrabImageRGBD1(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, string filename);
...
public:
	...
	cv::Mat mImDepth; // depth image                    
    cv::Mat mImRGB;   // color image
...
protected:
	...
	bool TrackHomo(cv::Mat& homo);// The homography transformation matrix was obtained two frames ago====
    ...
    bool Relocalization();
    bool Relocalization(bool save_changed);// Add whether to record relocation records
...
/*    bool mbCreatedMap;*/
    ...
    Sophus::SE3f mVelocity;
	 ...
	 //Motion Model  camera movement speed======
/*    cv::Mat mVelocity;// mVelocity = mCurrentFrame.mTcw*LastTwc;//The movement speed is the transformation matrix of the front and rear needles.*/
