...
protected:
	...
	// Map reading and writing implementation functions====
	void _WriteMapPoint(ofstream &f, MapPoint* mp);// Write map points=====
	void _WriteKeyFrame(ofstream &f, KeyFrame* kf, map<MapPoint*, unsigned long int>& idx_of_mp);// Write keyframes====
